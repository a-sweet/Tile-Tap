...
- (void)viewDidLoad
{
    ...
    self.Blue1.layer.cornerRadius = 5;
    self.Blue2.layer.cornerRadius = 5;
    self.Blue3.layer.cornerRadius = 5;
    self.Blue4.layer.cornerRadius = 5;
    self.Red1.layer.cornerRadius = 5;
    self.Red2.layer.cornerRadius = 5;
    self.Red3.layer.cornerRadius = 5;
    self.Red4.layer.cornerRadius = 5;
...
- (IBAction)RestartGame:(id)sender {
    ...
    x = 0;
    [myTimer invalidate];
    myTimer = [NSTimer scheduledTimerWithTimeInterval:0.25 target:self selector:@selector(RandomRed) userInfo:nil repeats: YES];
    Pause = 1;
    stopper = 0;
    YesNewGame = 1;
